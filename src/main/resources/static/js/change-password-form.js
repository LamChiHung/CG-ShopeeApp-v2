let submitButton = document.getElementById("change-password-submit-button");
...
function hideShowPassword() {
    let openEye = document.querySelector(".change-password-container-content-item-2-form-body-item-1-inputPassword-openEyeIcon");
    let password = document.querySelector(".change-password-container-content-item-2-form-body-item-1-inputPassword");
...
function checkValidCorrectPassword() {
    let password = document.querySelector(".change-password-container-content-item-2-form-body-item-1-inputPassword");
    let correctPassword = document.querySelector(".change-password-container-content-item-2-form-body-item-1-inputCorrectPassword");
    let messageCorrectPassword = document.querySelector(".invalidCorrectPassword-announce");
    let checkIcon = document.querySelector(".change-password-container-content-item-2-form-body-item-1-inputCorrectPassword-checkIcon");
...
function checkInput() {
    let email = document.querySelector(".change-password-container-content-item-2-form-body-item-1-inputEmail");
    let password = document.querySelector(".change-password-container-content-item-2-form-body-item-1-inputPassword");
    let submitButton = document.querySelector(".change-password-container-content-item-2-form-body-item-1-submitsignup");
